...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title =
    config.title ??
    "Stars, Stripes & Wild India — Astrophotography & Tiger Expedition"
  const description =
    config.description ??
    "An exclusive 10-day Astrophotography and Tiger Photography Expedition in Ranthambore & Hanle, India."
