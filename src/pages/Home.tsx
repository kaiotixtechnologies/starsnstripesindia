...
const WHY_TOUR_STANDS_OUT: ReactNode[] = [
  "Small group — Maximum of 8 guests; max. 2 guests per vehicle for all half-day safaris; max 3 guests per vehicle for all full-day safaris.",
...
const WHATS_INCLUDED: ReactNode[] = [
  ...
  <span>
    All safari jeep and park permit fees for Pench and Tadoba-Andhari, core and
    buffer zones (7 half-day safaris (<strong>2 photographers per jeep</strong>)
    and 2 full-day safaris (<strong>max. 3 photographers per jeep</strong>))
  </span>,
...
const TOUR_HIGHLIGHTS = [
  ...
  "Accommodation in luxury jungle lodges with all meals included (dietary restrictions will be accommodated), near national park gates in both Pench and Tadoba.",
]
...
export default function Home() {
  return (
    <>
      ...
      >
        <div
          className="absolute inset-x-0 bottom-0 top-[84px] bg-cover bg-center"
          style={{ backgroundImage: `url(${IMG_HERO})` }}
        />
        <div
          className="absolute inset-x-0 bottom-0 top-[84px]"
          style={{
            background:
              "linear-gradient(to bottom, rgba(7,13,22,0.5) 0%, rgba(7,13,22,0.3) 30%, rgba(7,13,22,0.72) 75%, rgba(7,13,22,0.98) 100%)",
          }}
        />
        <div className="relative z-10 max-w-4xl mx-auto px-6 pt-[130px] pb-14 flex flex-col items-center gap-4">
          ...
          {/* Title */}
          <h1
            className="hero-in hero-in-d1 font-serif font-black text-white leading-[0.95] tracking-tight uppercase"
          ...
          {/* Subtitle */}
          <p
            className="hero-in hero-in-d2 font-serif text-xl md:text-2xl italic font-normal"
            style={{ color: "#E8D5B5" }}
          >
          ...
          <div className="hero-in hero-in-d2 mt-1">
            <p className="eyebrow text-xs tracking-widest text-white/70">
              Dates:
            </p>
            <p
      ...
      <section style={{ background: "#FAFAF7" }} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <FadeIn>
            ...
            <h2
              className="font-serif text-3xl md:text-4xl font-bold leading-tight mb-8"
              style={{ color: "#0D1B2A" }}
            >
            ...
            <p
              ...
              style={{ color: "#3D4F60" }}
            >
              This 10-day India photography tour combines two extraordinary
              experiences in one seamless itinerary — the inaugural edition of
              what we intend to run as a recurring expedition. Two of the most
              compelling subjects in nature photography in one trip: dark-sky
              astrophotography and Bengal tiger wildlife photography. The
              journey opens in the pristine, internationally certified dark
              skies of Pench National Park, which was designated India's first
              Dark Sky Park in January 2024 with developed stargazing
              infrastructure including observatory facilities. Pench is a rare
              setting for night-sky photography inside a tiger landscape. The
              second half moves to Tadoba-Andhari Tiger Reserve, one of central
              India's best-known tiger destinations, where photographers work
              from safari vehicles in search of Bengal tigers and other wildlife
            ...
            <p
              ...
              style={{ color: "#3D4F60" }}
            >
              Built for photographers of all levels, this journey balances
              instruction, comfort, and field time. The tone of the trip is
              luxury in accommodation, expedition-style in wildlife experience,
              and educational in photography guidance.
            </p>

            <div
              className="my-10 p-8 rounded-sm bg-white"
              style={{
              ...
              <ul className="flex flex-col gap-4">
                {WHY_TOUR_STANDS_OUT.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <span className="text-[#A07828] font-bold text-base leading-tight mt-0.5">
                      •
                    </span>
                    <span
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              {/* Pench National Park */}
              <div
                className="p-8 rounded-sm bg-white flex flex-col justify-between"
                style={{
                  border: "1px solid rgba(13,27,42,0.08)",
                  boxShadow: "var(--shadow)",
                }}
              >
                <div>
                  ...
                  <p
                    ...
                    style={{ color: "#4A5568" }}
                  >
                    Pench Tiger Reserve became India's first Dark Sky Park in
                    January 2024, recognizing successful efforts to reduce light
                    pollution and improve the quality of the night sky. Set
                    among forest, meadows and open clearings, Pench pairs a
                    rare, internationally certified dark sky with a genuine
                    tiger landscape — a setting built for star trails,
                    wide-field nightscapes, twilight landscapes, and
                    environmental wildlife imagery, all without leaving the
                    reserve.
                  </p>
                </div>
                <div
                  className="rounded-sm overflow-hidden h-48"
                  style={{ background: "#e8e0d4" }}
                >
                  <img
                    src={IMG_MILKY}
                    alt="Milky Way over Pench"
              ...
              >
                <div>
                  ...
                  <p
                    ...
                    style={{ color: "#4A5568" }}
                  >
                    Tadoba-Andhari Tiger Reserve is Maharashtra's oldest and
                    largest national park, and one of India's most tiger-dense
                    reserves — a mosaic of dry deciduous forest, teak groves and
                    shimmering lakes where sightings of the Bengal tiger are
                    among the most reliable in the world. Its remote buffer
                    villages sit far from major light pollution, and April's dry
                    season draws animals to shrinking waterholes, making this
                    the peak window for tiger encounters in central India, with
                    a mix of full-day and half-day safaris to maximize your time
                    in the field.
                  </p>
                </div>
                <div
      ...
      <section style={{ background: "#FFFFFF" }} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <FadeIn
            className="rounded-sm overflow-hidden bg-[#FAFAF7]"
            style={{
              border: "1px solid rgba(13,27,42,0.08)",
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div
                className="p-10"
                style={{ borderRight: "1px solid rgba(13,27,42,0.08)" }}
              >
                <h3
                  className="font-serif text-2xl font-bold mb-6"
                  style={{ color: "#0D1B2A" }}
      ...
      <section style={{ background: "#FFFFFF" }} className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            ...
            <div
              className="p-8 md:p-10 rounded-sm bg-[#F2EDE2] flex flex-col gap-5"
            ...
            >
              ...
              >
                <strong>
                  This expedition is built around vehicle-based safaris
                </strong>{" "}
                — you'll spend your days seated in an open 4x4, not on foot, so
                there's no hiking fitness required to take part. Nights are
                spent at accessible, flat viewpoints for astrophotography,
                generally a short walk from the vehicle.
              </p>
              ...
              <p
                ...
                style={{ color: "#4A5568" }}
              >
                If you've been hesitant about a wildlife trip because of
                physically demanding treks, or you've wanted to try
                astrophotography but didn't know where to start, this tour is
              ...
              <p
                ...
                style={{ color: "#4A5568" }}
              >
                Safaris run early morning and late afternoon to match the best
                light and highest tiger activity — with two full-day safaris in
                Tadoba for those who want maximum time in the field — and nights
                (when clear) run late for star photography, so days can be long.
                A basic level of alertness and flexibility around an
                early-and-late schedule will help you enjoy it fully.
              </p>
              ...
              <div className="mt-2 p-4 rounded-sm bg-white/70 border border-[#A07828]/20">
                <p
                  ...
                  style={{ color: "#7A5C1E" }}
                >
                  Note: Pench and Tadoba both sit at low elevations, so there is
                  no concern about altitude sickness on this trip.
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <OutlineBtn to="/itinerary">
                Explore Day-by-Day Itinerary
              </OutlineBtn>
            </div>
          </FadeIn>
        </div>
