...
const INCLUDED_SUMMARY: ReactNode[] = [
  ...
  <span>
    All safari jeep and park permit fees for Pench &amp; Tadoba-Andhari: 7
    half-day safaris (<strong>2 photographers per jeep</strong>) and 2 full-day
    safaris (<strong>max. 3 photographers per jeep</strong>)
  </span>,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Link
                    to="/whats-included"
                    className="text-xs font-semibold text-[#A07828] hover:underline"
                  >
                    View Full Details →
                  </Link>
                </div>
              ...
              <div className="p-8 md:p-10 bg-[#FAFAF7]">
                ...
                <div className="mt-8 pt-6 border-t border-black/[0.06]">
                  <Link
                    to="/whats-included"
                    className="text-xs font-semibold text-[#A07828] hover:underline block mb-1"
                  >
      ...
      <section style={{ background: "#FFFFFF" }} className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            ...
            <h2
              className="font-serif text-3xl md:text-4xl font-bold mb-8 uppercase tracking-wide"
              style={{ color: "#0D1B2A" }}
            >
              HOW TO BOOK?
            </h2>
            ...
            <div className="p-8 md:p-10 rounded-sm bg-[#F2EDE2] border border-[#A07828]/20 flex flex-col gap-6">
              ...
              >
                ...
                secure your place, please fill in the form on our booking page.
              </p>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            ...
            <div
              className="p-8 md:p-10 rounded-sm bg-white mb-8"
              style={{
                border: "1px solid rgba(13,27,42,0.08)",
            ...
            >
              ...
              <div className="pt-6 border-t border-black/[0.08]">
                <p className="text-sm leading-relaxed text-[#4A5568]">
                  Two of our four Tadoba days are dedicated full-day safaris —
                  the same format used by leading international
                  tiger-photography operators — maximizing time in the field
                  across the full arc of daylight, from first light through the
                  midday lull and into evening color.
                </p>
              </div>
            </div>
