    ...
    <>
      ...
      <section style={{ background: "#FAFAF7" }} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <FadeIn>
            <Eyebrow className="mb-3 text-xs" style={{ color: "#1A4080" }}>
              Astrophotography &amp; Tigers · 4 Nights
            </Eyebrow>
            <h2
            ...
            <p
              className="text-sm font-semibold leading-relaxed mb-8"
              style={{ color: "#7A5C1E" }}
            >
              Four nights in India's first Dark Sky Park: 3 afternoon safaris
              with 2-photographers per vehicle for maximum photography comfort
              co-directed by Himanshu and Srini; and 4 astrophotography sessions
              guided by Abhishek, joined by Srini.
            </p>

            <div
              className="p-8 rounded-sm bg-white mb-10"
              style={{
      ...
      <section style={{ background: "#FFFFFF" }} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <FadeIn>
            <Eyebrow className="mb-3 text-xs" style={{ color: "#1A5030" }}>
              Tiger Sanctuary Focus · 5 Nights
            </Eyebrow>
            <h2
              className="font-serif text-3xl md:text-4xl font-bold mb-4"
              style={{ color: "#0D1B2A" }}
            ...
            <p
              ...
              style={{ color: "#3D4F60" }}
            >
              Tadoba-Andhari is widely recognized by wildlife photography
              operators as one of the best destinations in India for Bengal
              tiger safaris, with strong additional chances for leopard, dhole
              (Indian wild dog), sloth bear, and Indian gaur. Tadoba-Andhari
              Tiger Reserve is also home to over 200 bird species, featuring a
              dense concentration of wetland birds, waterfowl, and vibrant
              forest species that cluster around its prominent permanent lakes
              during the dry season including the Oriental Darter, Black-naped
              Monarch, Tickell's Blue Flycatcher, Pheasant-tailed Jacana,
              Black-hooded Oriole, Crested Treeswift, and the endangered Lesser
              Adjutant Stork around its deep woodland lakes. April is the best
              season for animal and bird encounters due to the dry conditions,
              especially around water sources and in open habitat at dawn and
              dusk.
            </p>
            ...
            <p
              ...
              style={{ color: "#1A5030" }}
            >
              Five nights at Tadoba-Andhari, with a mix of full-day and half-day
              safaris across four days: 6 safaris totaling 40 hours in the
              field, including two full 12-hour days — the same format used by
              leading international tiger-photography operators — with Himanshu
              and Srini rotating between vehicles throughout.
            </p>

            <div
              className="p-8 rounded-sm bg-[#FAFAF7] mb-10"
              style={{
                border: "1px solid rgba(13,27,42,0.08)",
                boxShadow: "var(--shadow)",
              }}
            >
              ...
              <ul className="flex flex-col gap-3.5">
                {TADOBA_THEMES.map((theme, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <span className="text-[#1A5030] font-bold text-base leading-tight mt-0.5">
                      •
                    </span>
                    <span
                      className="text-sm leading-relaxed"
      ...
      <section style={{ background: "#F2EDE2" }} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <FadeIn
              className="p-8 rounded-sm bg-white h-full"
              style={{
                border: "1px solid rgba(13,27,42,0.08)",
                boxShadow: "var(--shadow)",
              }}
            >
              <h3
                className="font-serif text-2xl font-bold mb-6 uppercase tracking-wide"
                style={{ color: "#0D1B2A" }}
              >
                WHAT GUESTS WILL PHOTOGRAPH
              </h3>
          ...
          <FadeIn
            delay={150}
            className="mt-10 p-8 rounded-sm bg-white"
            style={{
              borderLeft: "4px solid #A07828",
              boxShadow: "var(--shadow)",
            }}
          >
            <p
              ...
              style={{ color: "#0D1B2A" }}
            >
              <strong>Hands-on support throughout:</strong> two co-directors
              present for the full trip, joined by a specialist astrophotography
              expert for four nights in Pench — help is always close at hand,
              whether you're troubleshooting a star tracker at 1 AM or
              repositioning for a tiger's next move.
            </p>
          </FadeIn>
        </div>
      </section>
