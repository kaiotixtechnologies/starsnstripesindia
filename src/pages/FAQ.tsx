  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Airport transfers at Nagpur, all inter-park transport in 4x4 Innovas, all safari jeep and national park permit fees (9 safaris total), twin-share AC lodge accommodations with private bathrooms, all meals (breakfast, lunch, dinner — dietary restrictions will be accommodated), safari refreshments, 4 Pench astro sessions, photo review/post-processing workshops, and pre-tour online planning call.",
      },
      {
                ...
                {section.items.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span
                          className="font-semibold text-sm leading-snug pr-6"
                          style={{ color: "#0D1B2A" }}
                        >
                          {item.q}
                        </span>
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-sm mb-8" style={{ color: "#637282" }}>
              Send us a message or schedule your pre-tour conversation.
            </p>
