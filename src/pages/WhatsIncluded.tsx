            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 md:p-10 bg-[#FAFAF7]">
                ...
                <p className="mt-8 text-xs italic text-[#637282]">
                  See booking terms and conditions for our full refund and
                  cancellation policy.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            <Eyebrow className="mb-3 text-xs">
              Jungle Lodges &amp; 4x4 Fleet
            </Eyebrow>
            <h2
              className="font-serif text-3xl font-bold mb-8 uppercase tracking-wide"
              style={{ color: "#0D1B2A" }}
            >
              ACCOMMODATION &amp; TRANSPORTATION
            </h2>
            ...
            <div
              className="p-8 md:p-10 rounded-sm bg-[#F2EDE2] mb-10"
            ...
            >
              ...
              >
                ...
                gates. Single occupancy is available on request for US$ 1,500.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div className="p-5 bg-white rounded-sm border border-black/[0.05]">
                  ...
                  <p className="text-sm font-semibold text-[#0D1B2A]">
                    Saj in the Forest, a boutique resort set across 32 acres
                    adjoining Pench's buffer zone, near Turia Gate
                  </p>
                </div>
                <div className="p-5 bg-white rounded-sm border border-black/[0.05]">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm font-semibold text-[#0D1B2A]">
                    Tathastu Tadoba (The Tiger Village Resort), just over a
                    kilometer from Tadoba-Andhari's Moharli Gate
                  </p>
                </div>
              </div>
              ...
              <p
                ...
                style={{ color: "#4A5568" }}
              >
                All transportation is included: private 4x4 Innova vehicles for
                transfers, and safari vehicles throughout both parks — 4
                vehicles (2 guests each) for all Pench safaris and for two of
                the four Tadoba days, and 3 vehicles (the park regulation limit
                for full-day safaris) on our two full-day Tadoba days.
                Co-directors Himanshu and Srini rotate between vehicles
                throughout to ensure every guest spends time with both.
              </p>
            </div>
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <p
                  ...
                  style={{ color: "#4A5568" }}
                >
                  <strong>Gate rotation:</strong> Indian tiger reserves assign
                  safari zones by permit, so we'll rotate gates daily to
                  maximize sighting variety — this also means the exact schedule
                  may shift based on permit availability.
                </p>
                <p
                  className="text-sm leading-relaxed"
                  style={{ color: "#4A5568" }}
                >
                  <strong>Drones:</strong> Please note that India's import
                  regulations make it very difficult for tourists to bring
                  personal drones into the country, and drones are not permitted
                  inside either reserve in any case. We recommend leaving drones
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            <p
              ...
              style={{ color: "#0D1B2A" }}
            >
              Ready to review pricing and reserve?
            </p>
            <p className="text-sm text-[#637282] mb-8">
              US$ 6,900 per person · Limited to 8 photographers · US$ 2,000
