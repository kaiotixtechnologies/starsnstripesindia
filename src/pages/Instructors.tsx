  ...
  return (
    <>
      ...
      <section style={{ background: "#FAFAF7" }} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <FadeIn>
            ...
            <h2
              className="font-serif text-3xl md:text-4xl font-bold mb-12 uppercase tracking-wide"
              style={{ color: "#0D1B2A" }}
            >
              YOUR CO-DIRECTORS
            </h2>
              ...
              >
                <div>
                  ...
                  <p
                    ...
                    style={{ color: "#4A5568" }}
                  >
                    Himanshu has photographed over 700 individual tigers across
                    more than two decades in India's national parks, and tracks
                    individual tigers by name and territory across Pench and
                    Tadoba. Guests consistently cite his sighting reliability
                    and his commitment to unmanipulated, in-camera photography.
                    Himanshu co-guides tiger photography tours with renowned
                    wildlife photographer and tour leader Paul Goldstein, an
                    association that has shaped Himanshu’s own approach to
                    guiding and field photography. See more of his work at
                    himanshubagde.com and @himanshubagde_wildlife.
                  </p>
                </div>
              </div>
              ...
              >
                <div>
                  ...
                  <p
                    ...
                    style={{ color: "#4A5568" }}
                  >
                    Srini co-directs and organizes this expedition alongside
                    Himanshu, and leads the trip's astrophotography coaching and
                    Lightroom/Photoshop post-processing instruction throughout.
                    An advanced astrophotography and landscape photographer with
                    a growing interest in wildlife and bird photography, he has
                    completed international expeditions to Lofoten and La Palma
                    for astrophotography and to Iceland and Patagonia for
                    landscape work, with Namibia and the Pantanal upcoming. He
                    spent 30 years working in senior positions in international
                    development finance, and currently combines this venture
                    with an academic position as Visiting Research Professor at
            ...
            >
              ...
              <Eyebrow
                ...
                style={{ color: "#1A4080" }}
              >
                DarkSky International Advocate
              </Eyebrow>
              <h3
              ...
              <p
                ...
                style={{ color: "#4A5568" }}
              >
                Abhishek joins the expedition for four nights in Pench as our
                astrophotography expert. He is a DarkSky International advocate
                whose work with the Pench Forest Department helped secure
                Pench's designation as India's first Dark Sky Park in January
                2024, and leads our night-sky sessions, covering star tracking,
                exposure stacking, and post-processing for Milky Way and
                star-trail imagery.
              </p>
            </div>
          </FadeIn>
      ...
      <section style={{ background: "#FFFFFF" }} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <FadeIn>
            <Eyebrow className="mb-3 text-xs">
              Packing &amp; Gear Checklist
            </Eyebrow>
            <h2
              className="font-serif text-3xl md:text-4xl font-bold mb-3 uppercase tracking-wide"
              style={{ color: "#0D1B2A" }}
            >
              WHAT TO BRING
            </h2>
            <p className="text-sm leading-relaxed mb-12 text-[#637282]">
              We'll send a complete packing list upon sign-up. A summary of what
              you'll likely need:
            </p>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Photography gear */}
            <FadeIn
              className="p-8 rounded-sm bg-[#FAFAF7]"
              style={{ border: "1px solid rgba(13,27,42,0.07)" }}
            >
            ...
            >
              ...
              <p
                ...
                style={{ color: "#4A5568" }}
              >
                The currency in India is the Indian Rupee (INR). Credit/debit
                cards are accepted at most lodges, but cash is useful for tips
                and small purchases in nearby villages. We recommend exchanging
                currency in Nagpur or withdrawing from an ATM on arrival.
              </p>
              ...
              <div className="pt-4 border-t border-black/[0.06]">
                ...
                <p
                  ...
                  style={{ color: "#4A5568" }}
                >
                  Most nationalities require an e-Visa or tourist visa to enter
                  India — apply well in advance of departure. We can point you
                  to official visa resources, but you're responsible for your
                  own application.
                </p>
              </div>
            </FadeIn>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            <p
              ...
              style={{ color: "#0D1B2A" }}
            >
              Ready to photograph with our team?
            </p>
