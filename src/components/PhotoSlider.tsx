...
export default function PhotoSlider({
  ...
  return (
    ...
    >
      ...
      {/* Edge Gradient Fades for Infinite Sliding Effect */}
      <div className="relative w-full overflow-hidden">
        <div
          className="absolute top-0 bottom-0 left-0 w-16 sm:w-32 z-10 pointer-events-none"
          style={{
            background: isDark
        ...
        />
        <div
          className="absolute top-0 bottom-0 right-0 w-16 sm:w-32 z-10 pointer-events-none"
          style={{
            background: isDark
        ...
        >
          {marqueeItems.map((photo, index) => (
            <div
              ...
              className="flex-shrink-0 w-[280px] sm:w-[380px] md:w-[460px] h-[200px] sm:h-[260px] md:h-[310px] rounded-sm overflow-hidden cursor-pointer group relative transition-transform duration-300 transform hover:scale-[1.02]"
              style={{
            ...
            >
              <img
                src={photo.image}
                alt={photo.alt || "Expedition Photo"}
                loading="lazy"
